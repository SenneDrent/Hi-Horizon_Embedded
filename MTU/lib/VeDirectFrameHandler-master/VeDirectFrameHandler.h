...
const byte frameLen = 23;                       // VE.Direct Protocol: max frame size is 18
...
#define MPPT_VOLTAGE  3
#define MPPT_CURRENT  4
#define MPPT_VPV      5
#define MPPT_PPV      6
#define MPPT_CS       7
#define MPPT_MPPT     8
...
public:
    ...
    int veEnd;
    bool checksumState;                                  // current size (end) of the public buffer
